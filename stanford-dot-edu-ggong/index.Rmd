...
---
title: "rmap---v-0.01-07---2016-06-09 14:43:37 PDT"
author: ''
output:
  html_document:
...
# For estimating the concordance of a risk model with outcomes observed in cohort studies with censored times to outcome see the package [bconcordance](http://stanford.edu/~ggong/bconcordance/).
...
**The package `bconcordance` offers a new estimate for the concordance in the presence of censored survival data.  Please see
[bconcordance](http://http://stanford.edu/~ggong/bconcordance/).**
