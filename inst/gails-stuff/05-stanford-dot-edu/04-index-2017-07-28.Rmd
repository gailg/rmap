---
title: "rmap---v-0.02-03--2017-07-28 13:20:41 PDT"
author: ''
output:
  html_document:
...
```{r}
rmap_random_sample_individual_too = function(e, t, r, t_star, K = 4, N_bootstraps = 100){
  ...
  individual = if(N_bootstraps > 0){
    epsilon = length(e)^(-1/3)
    risk_group = list(epsilon = epsilon)
    rmap_individual(e, t, r, t_star, design, risk_group, r_summary, 
         N_bootstraps, confidence_level, N_cores, verbose)
  } else {
    NULL
  }
...
t_star = 10
set.seed(1)
rmap_2 = rmap_random_sample_individual_too(e, t, r, t_star)
rmap_answers = rmap_2$rmap_answers
individual = rmap_2$individual
the_message = paste("rmap_random_sample_individual_too plots", sep = "\n")
grid.arrange(textGrob(the_message), pretty_risk_plot(rmap_answers), 
             pretty_roc_plot(rmap_answers), pretty_individual_risk_plot(individual),
             ncol = 2)
```
