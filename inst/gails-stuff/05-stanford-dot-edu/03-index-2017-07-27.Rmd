...
rmap_random_sample_ungrouped_too = function(e, t, r, t_star, K = 4, N_bootstraps = 100){
  ...
  ungrouped = if(N_bootstraps > 0){
    epsilon = length(e)^(-1/3)
    risk_group = list(epsilon = epsilon)
    rmap(e, t, r, t_star, design, risk_group, r_summary, 
         N_bootstraps, confidence_level, N_cores, verbose)
  } else {
    NULL
  }
...
pretty_roc_plot = function(grouped){
...
pretty_grouped_risk_plot = function(grouped){
  numerical_summaries = grouped$numerical_summaries
...
pretty_ungrouped_risk_plot = function(ungrouped){
...
set.seed(1)
rmap_2 = rmap_random_sample_ungrouped_too(e, t, r, t_star)
grouped = rmap_2$grouped
ungrouped = rmap_2$ungrouped
the_message = paste("rmap_random_sample_ungrouped_too plots", sep = "\n")
grid.arrange(textGrob(the_message), pretty_grouped_risk_plot(grouped), 
             pretty_roc_plot(grouped), pretty_ungrouped_risk_plot(ungrouped),
             ncol = 2)
```
