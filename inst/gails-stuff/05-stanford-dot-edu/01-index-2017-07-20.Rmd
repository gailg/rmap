...
# A first look at `rmap`

Next try the following.  Don't worry about the meaning of each line.  I will discuss the details below, but I hope the following shows you the scope of what `rmap` can do... ROC plots, grouped and ungrouped attribute diagrams, goodness of fit statistics, concordance estimates and confidence intervals.
...
ungrouped = rmap(e, t, r, t_star, design, risk_group, r_summary, 
              N_bootstraps, confidence_level, N_cores, verbose)
roc_plot = grouped$plots$roc_plot
grouped_risk_plot = grouped$plots$risk_plot
ungrouped_risk_plot = ungrouped$plots$risk_plot
```

```{r fig.height = 3.5, fig.width = 3.5}
grid.arrange(roc_plot, top = "ROC plot")
```

```{r fig.height = 3.5, fig.width = 7}
grid.arrange(grouped_risk_plot, ungrouped_risk_plot, ncol = 2,
             top = "Grouped and ungrouped attribute diagrams")
grouped$numerical_summaries
```
