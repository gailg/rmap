...
N_bootstrap = 0
set.seed(7)
rmap_7 = rmap(e, t, r1, t_star, design, risk_group, r_summary, 
              N_bootstraps, confidence_level, N_cores, verbose)
rmap_8 = rmap(e, t, r2, t_star, design, risk_group, r_summary, 
              N_bootstraps, confidence_level, N_cores, verbose)
epsilon = nrow(xxx)^(-1/3)
risk_group = list(epsilon = epsilon)
bootstrap = 100
rmap_9 = rmap(e, t, r1, t_star, design, risk_group, r_summary, 
              N_bootstraps, confidence_level, N_cores, verbose)
rmap_10 = rmap(e, t, r1, t_star, design, risk_group, r_summary, 
              N_bootstraps, confidence_level, N_cores, verbose)
rmap_7$summary
rmap_8$summary
