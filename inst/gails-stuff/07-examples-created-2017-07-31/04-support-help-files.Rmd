...
For a risk model, produce the necessary objects to estimate and provide a confidence interval for concordance, produce an ROC plot, perform a grouped goodness-of-fit test, and get a grouped attribute diagram.
